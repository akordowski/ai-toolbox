...
public class ServiceCollectionExtensionsAIToolboxTests
{
    ...
    private readonly Mock<Action<IAIToolboxBuilder>> _builderActionMock = new();
    ...
    public static TheoryData<Action, string, Type> AddAIToolboxWithInvalidParameters
    {
        get
        {
            Action<IAIToolboxBuilder> nullBuilderAction = null!;
    ...
    public void Should_Add_AIToolbox_With_Default_Options()
    {
        ...
        // Assert
        _builderActionMock.Verify(action => action(It.IsAny<IAIToolboxBuilder>()), Times.Once);
    }
    ...
    public void Should_Add_AIToolbox_With_Configuration_And_Default_Section_Name()
    {
        ...
        // Assert
        _builderActionMock.Verify(action => action(It.IsAny<IAIToolboxBuilder>()), Times.Once);
        _builderActionMock.Verify(action => action(It.Is<IAIToolboxBuilder>(builder => builder.Options != null)), Times.Once);
    }
